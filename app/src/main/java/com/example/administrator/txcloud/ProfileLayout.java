...
public class ProfileLayout extends LinearLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        if (profile != null) {
            ...
            SharedPreferences shareInfo = getContext().getSharedPreferences(Constans.USERINFO, Context.MODE_PRIVATE);
            String url = shareInfo.getString(Constans.ICON_URL, "");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.modify_user_icon) {
            ...
            editor.putString(Constans.ICON_URL, mIconUrl);
            editor.commit();
